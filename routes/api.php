...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/classes/{class}/fund-account', [FundAccountController::class, 'show']);
    Route::put('/classes/{class}/fund-account', [FundAccountController::class, 'upsert']);
    Route::get('/classes/{class}/fund-account/summary', [FundAccountController::class, 'summary']);
    Route::get('/classes/{class}/ledger', [FundAccountController::class, 'ledger']);
...
Route::get('/__debug/enqueue', function () {
    dispatch(function () {
        Log::warning('DEBUG queued closure fired');
    })->onQueue('payments');
